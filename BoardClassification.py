...
#############
# model define
class BoardClssifier(nn.Module):
    def __init__(self, ckpt_path = None):
        ...
        self.resnet18.fc = nn.Linear(self.resnet18.fc.in_features, 4)
...
def build_model(ckpt_path = None):
    return BoardClssifier(ckpt_path=ckpt_path)


class BoardClssifier_(nn.Module):
